...
namespace CultistTheme.Tiles
{
	public class CultistMusicBox : ModTile
	{
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<Items.CultistMusicBox>());
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Items.CultistMusicBox>();
		}
